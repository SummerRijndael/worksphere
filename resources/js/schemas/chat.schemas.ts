...
export const messageSchema = z.object({
  ...
  edited_by_user_public_id: z.string().nullable().optional(),
  edited_by_user_name: z.string().nullable().optional(),
  is_deleted: z.boolean().optional(),
  deleted_at: z.string().nullable().optional(),
  deleted_by_user_public_id: z.string().nullable().optional(),
  deleted_by_user_name: z.string().nullable().optional(),
  edit_history_count: z.number().optional(),
