...
<template>
    <div class="min-h-screen bg-[var(--surface-primary)]">
        ...
        >
            <div
                class="p-4 rounded-full bg-red-100 dark:bg-red-900/20 text-red-600"
            >
                <Globe class="h-8 w-8" />
            </div>
        ...
        >
            ...
            <Card padding="none" class="overflow-visible">
                <!-- Cover Image -->
                <div
                    class="h-50 bg-[var(--surface-secondary)] rounded-t-xl relative overflow-hidden"
                >
                    <img
                ...
                <div class="px-8 pb-8">
                    ...
                    >
                        ...
                        >
                            ...
                            {{
                                user?.created_at
                                    ? formatDateComposible(user.created_at)
                                    : ""
                            }}
                        </div>
                        <div
