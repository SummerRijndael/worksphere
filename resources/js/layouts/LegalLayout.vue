...
<template>
    <div class="min-h-screen bg-[var(--surface-primary)]">
        <!-- Header -->
        <header
            class="sticky top-0 z-50 border-b border-[var(--border-default)] bg-[var(--surface-elevated)]/95 backdrop-blur-sm"
        >
            <div
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <RouterLink to="/" class="flex items-center gap-2">
                        <div
                            class="h-8 w-8 rounded-lg bg-[var(--interactive-primary)] flex items-center justify-center"
                        >
                            <svg
        ...
        <!-- Footer -->
        <footer
            class="border-t border-[var(--border-default)] bg-[var(--surface-elevated)]"
        >
