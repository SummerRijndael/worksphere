...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
             ...
             if (!from.name) next({ name: 'dashboard' }); else next();
        }
    },
    {
        path: '/500',
    ...
    },
    {
        ...
        beforeEnter: (to, from, next) => {
            ...
            if (to.query.verified === '1') {
                next();
            } else if (authStore.isAuthenticated && !authStore.user?.email_verified_at) {
                next();
            } else {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('@/views/client/ClientProjectDetailView.vue'),
                meta: {
                    title: 'Project Details',
                    breadcrumb: 'Project',
                    breadcrumbParent: { name: 'client.projects', label: 'Projects' },
                    transition: 'slide-fade',
                },
            },
            {
                ...
                component: () => import('@/views/client/ClientInvoicesView.vue'),
                meta: {
                    title: 'My Invoices',
                    breadcrumb: 'Invoices',
                    transition: 'slide-fade',
            ...
            },
            {
                ...
                component: () => import('@/views/client/ClientInvoiceDetailView.vue'),
                meta: {
                    title: 'Invoice Details',
                    breadcrumb: 'Invoice',
                    breadcrumbParent: { name: 'client.invoices', label: 'Invoices' },
                    transition: 'slide-fade',
                },
            },
            {
            ...
            },
            {
                ...
                meta: {
                    title: 'Task Details',
                    breadcrumb: 'Task',
                    breadcrumbParent: { name: 'project-detail', label: 'Project', paramKey: 'id', sourceParam: 'projectId' },
                    transition: 'slide-fade',
                },
            },
            {
            ...
            },
            {
                ...
                component: () => import('@/views/reports/TicketReportsView.vue'),
                meta: {
            ...
            },
            {
                ...
                component: () => import('@/views/admin/FaqArticleEditorView.vue'),
                meta: {
            ...
            },
            {
                ...
                meta: {
                    title: 'Team Roles',
                    breadcrumb: 'Roles',
                    breadcrumbParent: { name: 'team-profile', label: 'Team', paramKey: 'public_id' },
                    transition: 'slide-fade',
                },
            },
            {
            ...
            },
            {
                ...
                meta: {
                    title: 'Project Details',
                    breadcrumb: 'Project',
                    breadcrumbParent: { name: 'admin-projects', label: 'Projects' },
                    transition: 'slide-fade',
                    permission: 'user_manage',
                },
            },
            ...
            },
            {
                ...
                meta: {
                    ...
                    breadcrumbParent: { name: 'admin-invoices', label: 'Invoices' },
                    transition: 'slide-fade',
            ...
            },
            {
                ...
                component: () => import('@/views/system/GeneralSettingsView.vue'),
                meta: {
            ...
            },
            {
                ...
                component: () => import('@/views/system/AuditLogDetailView.vue'),
                meta: {
            ...
            },
            {
                ...
                component: () => import('@/views/admin/templates/TaskTemplatesView.vue'),
                meta: {
            ...
            },
            {
                ...
                component: () => import('@/views/admin/templates/InvoiceTemplatesView.vue'),
                meta: {
...
router.beforeEach(async (to: RouteLocationNormalized, from: RouteLocationNormalized, next: NavigationGuardNext) => {
    ...
    if (to.meta.requiresAuth) {
        ...
        const shouldFetchUser = !authStore.isAuthenticated ||
    ...
    if (authStore.isAuthenticated && !authStore.user?.email_verified_at && to.name !== 'verification.notice' && to.name !== 'setup-account') {
        next({ name: 'verification.notice' });
        return;
    }

    // Redirect verified users away from verification page
    if (to.name === 'verification.notice' && authStore.user?.email_verified_at) {
        next({ name: 'dashboard' });
        return;
    }

    // 2FA Enforcement Check - redirect if user needs to set up 2FA
    if (authStore.isAuthenticated && authStore.requires2FASetup && to.name !== 'enforce-2fa-setup') {
