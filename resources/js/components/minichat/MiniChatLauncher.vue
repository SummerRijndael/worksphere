...
watch(
    [unreadCount, unseenInvites],
    ([newUnread, newUnseen], [oldUnread, oldUnseen]) => {
...
<template>
    <div v-if="!authStore.isImpersonating" class="minichat-launcher-container">
        ...
        <button
            ...
            :class="{
                'is-active': miniChatStore.isLauncherOpen,
