...
const getPriorityColor = (priority: string | number) => {
    ...
    if (p === "4" || p === "urgent" || p === "critical")
        return "text-red-500 bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-900";
    if (p === "3" || p === "high")
        return "text-orange-500 bg-orange-50 dark:bg-orange-500/10 border-orange-200 dark:border-orange-900";
    if (p === "2" || p === "medium")
        return "text-blue-500 bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-900";
...
<template>
    <div
        class="overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-primary)] shadow-sm"
    >
                    ...
                    >
                        ...
                        <td class="px-4 py-3">
                            ...
                            >
                                ...
                                <div
                                    v-else
                                    class="flex items-center gap-2 text-[var(--text-muted)] bg-[var(--surface-secondary)]/50 px-2 py-1 rounded-md w-fit hover:bg-[var(--surface-secondary)] hover:text-[var(--text-primary)] transition-colors"
                                >
                        ...
                        <td class="px-4 py-3">
                            <div
                                ...
                                :class="{
                                    'text-rose-500 font-medium': isOverdue(
                                        task.due_date,
                                        task.status,
                                    ),
                                    'text-[var(--text-secondary)]': !isOverdue(
                                        task.due_date,
                                        task.status,
                                    ),
                                }"
                    ...
                    <tr v-if="tasks.length === 0" key="empty-state">
                        <td colspan="8" class="px-6 py-16 text-center">
                            ...
                            >
                                ...
                                <p
                                    class="text-xs text-[var(--text-muted)] max-w-xs"
                                >
                                    Get started by creating a new task or
